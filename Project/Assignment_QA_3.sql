...
select last_name , salary , salary/2, case when salary/2 > 10000 then salary * 1.10 + 1500 else salary * 1.115 + 1500
...
select first_name , last_name , job_id from employees where job_id = (select job_id , first_name from employees where first_name = "Trenna");
